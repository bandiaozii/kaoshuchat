  ...
  ["chunk-5b3da803"],
  {
    ...
    "37f9": function (t, e, s) {
      ...
      var I = {
        ...
        P = s("c00a"),
        O = {
          components: { SvgIcon: P["a"], Hamburger: b, Userinfo: M },
          computed: Object(o["a"])(
            {},
            Object(n["b"])([
              "sidebar",
      ...
      var D = function () {
          ...
          methods: {
            switchModule: function (t) {
              if (this.module !== t) {
                ...
                (this.module = t), (this.searchKeyword = ""), this.filterList();
              }
            },
            filterList: function () {
                ...
                e.forEach(function (s, i) {
                  if (s && s["prompts"] && s["prompts"].length > 0) {
                    ...
                    s["prompts"].forEach(function (e, i) {
                      var o = -1 === e.title.indexOf(t);
                      (s["prompts"][i].hidden = o), o || (a = !1);
                    }),
                      (s.hidden = a),
                      (e[i] = s);
                  }
                ...
                s.forEach(function (e, i) {
                  if (e && e["roles"] && e["roles"].length > 0) {
                    ...
                    e["roles"].forEach(function (s, i) {
                      var o = -1 === s.title.indexOf(t);
                      (e["roles"][i].hidden = o), o || (a = !1);
                    }),
                      (e.hidden = a),
                      (s[i] = e);
                  }
        ...
        ct =
          (s("d661"),
          s("05f5"),
          Object(v["a"])(rt, at, ot, !1, null, "20b66292", null)),
        lt = ct.exports,
        ut = function () {
          var t = this,
            e = t.$createElement,
      ...
      var xt = {
        ...
        jt = Ot,
        Tt =
          (s("2332"), Object(v["a"])(jt, Mt, Pt, !1, null, "0d572f78", null)),
        Gt = Tt.exports,
        Et = (s("6024"), s("74ea"), s("0227"), s("69f7"), []),
        Bt = 0,
        Ut = {
          name: "Main",
          components: { TextComponent: St, Welcome: Gt },
          data: function () {
            return {
              module: "chat",
              chatModel: "default",
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 7:
                          return (
                            ...
                            (a = "/web.php/chat/sendText"),
                            (o = { message: s }),
                            "chat" === t.module
                              ? ((o.group_id = t.group_id),
                                (o.model = t.chatModel))
                              : "write" === t.module
                              ? (o.prompt_id = t.prompt_id)
                              : "cosplay" === t.module &&
                                (o.role_id = t.role_id),
                            (e.next = 21),
                            fetch(a, {
      ...
      var Wt = s("9307"),
        ...
        Dt = {
          ...
          computed: Object(o["a"])(
            Object(o["a"])({}, Object(n["b"])(["hasModel4", "model4Name"])),
            {},
            {
              totalFee: function () {
                var t = this,
        ...
        ee = te,
        se =
          (s("6fe8"), Object(v["a"])(ee, Nt, Kt, !1, null, "323e5e77", null)),
        ie = se.exports,
        ae = s("4360"),
        oe = document,
        ne = oe.body,
        ...
        ce = {
          watch: {
            $route: function (t) {
              "mobile" === this.device &&
                this.sidebar.opened &&
                ae["a"].dispatch("app/closeSideBar", { withoutAnimation: !1 });
            },
          },
          ...
          mounted: function () {
            ...
            t &&
              (ae["a"].dispatch("app/toggleDevice", "mobile"),
              ae["a"].dispatch("app/closeSideBar", { withoutAnimation: !0 }));
          },
          methods: {
            $_isMobile: function () {
            ...
            $_resizeHandler: function () {
              if (!document.hidden) {
                var t = this.$_isMobile();
                ae["a"].dispatch("app/toggleDevice", t ? "mobile" : "desktop"),
                  t &&
                    ae["a"].dispatch("app/closeSideBar", {
                      withoutAnimation: !0,
                    });
              }
            },
        ...
        pe = de,
        he = Object(v["a"])(pe, i, a, !1, null, null, null);
