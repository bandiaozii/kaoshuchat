  ...
  ["chunk-1e9f2c86"],
  {
    ...
    "37f9": function (t, e, a) {
      ...
      var i = function () {
            ...
            [
              a("el-row", [
                a(
                  ...
                  [
                    a("div", { staticClass: "title" }, [t._v("数据统计")]),
                    a(
                      "div",
                      {
                        staticStyle: {
              ...
              a("el-row", [
                a("div", { staticClass: "el-col el-col-5" }, [
                  a("div", { staticClass: "card bg-gray" }, [
                    a("div", { staticClass: "header" }, [
                      a("i", { staticClass: "el-icon-user" }),
                      t._v(" 今日新增用户"),
                    ]),
                    a("div", { staticClass: "body" }, [
                      a("p", { staticClass: "big-font" }, [
                        t._v(t._s(t.tongji.userTotalNew)),
                      ]),
                      a("p", [
                        t._v("总计用户数"),
                        a("span", { staticClass: "badge" }, [
                          t._v(t._s(t.tongji.userTotal) + "人"),
                        ]),
                      ]),
                    ]),
                  ]),
                ...
                a("div", { staticClass: "el-col el-col-5" }, [
                  a("div", { staticClass: "card bg-gray" }, [
                    a("div", { staticClass: "header" }, [
                      a("i", { staticClass: "el-icon-s-data" }),
                      t._v(" 今日提问数"),
                    ]),
                    a("div", { staticClass: "body" }, [
                      a("p", { staticClass: "big-font" }, [
                        t._v(t._s(t.tongji.msgTotalNew)),
                      ]),
                      a("p", [
                        t._v("总计提问数"),
                        a("span", { staticClass: "badge" }, [
                          t._v(t._s(t.tongji.msgTotal) + "条"),
                        ]),
                      ]),
                    ]),
                  ]),
                ...
                a("div", { staticClass: "el-col el-col-5" }, [
                  a("div", { staticClass: "card bg-gray" }, [
                    ...
                    a("div", { staticClass: "body" }, [
                      a("p", { staticClass: "big-font" }, [
                        t._v(t._s(t.tongji.writeTotalNew)),
                      ]),
                      a("p", [
                        t._v("总计创作数"),
                        a("span", { staticClass: "badge" }, [
                          t._v(t._s(t.tongji.writeTotal) + "条"),
                        ]),
                      ]),
                    ]),
                  ]),
                ...
                a("div", { staticClass: "el-col el-col-5" }, [
                  a("div", { staticClass: "card bg-gray" }, [
                    ...
                    a("div", { staticClass: "body" }, [
                      a("p", { staticClass: "big-font" }, [
                        t._v(t._s(t.tongji.orderTotalNew)),
                      ]),
                      a("p", [
                        t._v("总计订单数"),
                        a("span", { staticClass: "badge" }, [
                          t._v(t._s(t.tongji.orderTotal) + "笔"),
                        ]),
                      ]),
                    ]),
                  ]),
                ]),
                a("div", { staticClass: "el-col el-col-4" }, [
                  a("div", { staticClass: "card bg-gray" }, [
                    a("div", { staticClass: "header" }, [
                      a("i", { staticClass: "el-icon-s-data" }),
                      t._v(" 今日收款金额"),
                    ...
                    a("div", { staticClass: "body" }, [
                      a("p", { staticClass: "big-font" }, [
                        t._v(t._s(t.tongji.orderAmountNew)),
                      ]),
                      a("p", [
                        t._v("总计收款金额"),
                        a("span", { staticClass: "badge" }, [
                          t._v(t._s(t.tongji.orderAmount) + "元"),
                        ]),
                      ]),
                    ]),
                  ]),
              ...
              a("el-row", [
                a("div", { staticClass: "title" }, [t._v("对话统计")]),
              ]),
              a("el-row", [
                a("div", { staticClass: "el-col el-col-24" }, [
                  a(
                    "div",
                    { staticClass: "card" },
                    [
              ...
              a("el-row", [
                a("div", { staticClass: "title" }, [t._v("订单统计")]),
              ]),
              a("el-row", [
                a("div", { staticClass: "el-col el-col-24" }, [
                  a(
        ...
        c = {
          ...
          props: {
            ...
            toolbox: { type: Object, default: null },
            tooltip: {
              type: Object,
              default: function () {
                return {
          ...
          methods: {
            draw: function () {
              this.echart || (this.echart = l.a.init(this.$refs.echart));
              var t = { series: this.series };
              this.yAxis
                ? (t.yAxis = this.yAxis)
                : this.yname &&
                  (t.yAxis = {
        ...
        d = c,
        h = a("3427"),
        u = Object(h["a"])(d, s, o, !1, null, null, null),
        g = u.exports,
        f = a("b775");
      function p(t) {
        return Object(f["a"])({
      ...
      var b = a("571f"),
        v = a("bb91"),
        x =
          "Ly9jb25zb2xlLnR0ay5pbmsvYXBpLnBocC9yZXBvcnQvc3VwZXIvcHJvZHVjdC9mb3hfY2hhdGdwdC9ob3N0Lw==",
        C = {
          name: "Dashboard",
          components: { echart: g },
          data: function () {
          ...
          mounted: function () {
            ...
            this.getSiteList(),
              ...
              (window.onresize = function () {
                t.$refs.echart &&
                  (t.$refs.orderEchart.resize(), t.$refs.msgEchart.resize());
              });
          },
          ...
          methods: {
            getTongji: function () {
              var t = this;
              p({ site_id: this.site_id }).then(function (e) {
                t.tongji = e.data;
              });
            },
            getSiteList: function () {
              var t = this;
              Object(b["e"])().then(function (e) {
                t.siteList = e.data;
              });
            },
            siteChange: function () {
            ...
            getOrderChartData: function () {
              var t = this;
              y({ site_id: this.site_id }).then(function (e) {
                t.orderEchartData = {
                  title: {
                    left: "center",
                    text: "交易笔数 & 收款金额",
                  ...
                  xAxis: { type: "category", data: e.data.times },
                  legend: {
                    data: ["订单笔数", "收款金额"],
                    top: 30,
                    itemWidth: 20,
                  ...
                  toolbox: {
                    ...
                    iconStyle: { borderColor: "rgba(64, 64, 64, 1)" },
                    right: 60,
                    top: 25,
                  },
                  dataZoom: [
        ...
        _ = C,
        w = (a("d972"), Object(h["a"])(_, i, r, !1, null, "f580bc52", null));
      e["default"] = w.exports;
    },
    "571f": function (t, e, a) {
      "use strict";
      ...
      function n(t) {
        return Object(i["a"])({ url: "/site/del", method: "post", data: t });
      }
      function l(t) {
        return Object(i["a"])({
          url: "/site/setStatus",
